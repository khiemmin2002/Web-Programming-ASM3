...
if (isset($_POST['register'])) {
  ...
  if ($error == "") {
    $file_open = fopen("data/data_user.csv", "a");
    $no_rows = count(file("data/data_user.csv"));
    if ($no_rows > 1) {
      $no_rows = ($no_rows - 1) + 1;
    }
    $form_data = array(
        ...
        <form method="post" action="" onsubmit="return validation()">
          ...
          <div class="user-details">
            ...
            <div class="input-box">
              ...
              <input type="password" name="repassword" id="retype_password" placeholder="Retype your password" maxlength="50" required>
            </div>
            <div class="input-box">
            ...
            <div class="input-box">
              ...
              <button type="submit" class="box" name="register">Send</button>
            </div>
          </div>
        </form>
      </div>

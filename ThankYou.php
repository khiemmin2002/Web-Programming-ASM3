...
<html lang="en-VN">
    <head>
        <title>Landing | Infinis Mall | The biggest shopping center in Vietnam</title>
        <meta charset="UTF-8">
        ...
        <link rel="stylesheet" type="text/css" href="ThankYou.css" media="screen">
    ...
    <body>
        ...
        <div class="thankyou">
            <h1>Thank You!</h1>
            <p class="lead"><strong>Please check your email</strong> for further instructions and to monitor your order status.</p>
            <hr>
            <p>

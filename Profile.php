...
<head>
    <title>My Profile | Infinis Mall | The biggest shopping center in Vietnam</title>
    <meta charset="UTF-8">
    ...
    <div id="container" class="site-container">
        <header>
            ...
            <nav class="main-menu">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="Login.php" class="active login-account">Login</a>
        ...
        <div class="main">
            <div class="account-box">
                <div class="box-title">
                    <h1>MY INFINIS ACCOUNT</h1>
                </div>
                <div class="account-type">
                    <div class="account-image">
                        <img src="images/Johnny Sins.jpg" alt="Johnny Sins" title="Profile's image">
                    </div>
                ...
                <div class="information">
                    <div class="basic">
                        <p><strong>First Name: </strong>Johnny</p>
                        <p><strong>Last Name: </strong>Sins</p>
                        <p><strong>Gender: </strong>Male</p>
                        <p><strong>Date of Birth: </strong>December 31<sup>st</sup>, 1978</p>
                        <p class="address"><strong>Address: </strong>Landmark 81, 772 Dien Bien Phu Street, Ward 1, Binh
                            Thanh District, Ho Chi Minh City</p>
                        <p><strong>ZIP Code: </strong>70000</p>
                    </div>
                    <div class="infinis">
                        <p><strong>E-mail: </strong><span id="login-mail">johnnysins3112@gmail.com</span></p>
                        <p><strong>Username: </strong><span id="login-username">johnnyfaketaxi122</span></p>
                        <p><strong>Tier: </strong>Diamond</p>
                    </div>
                </div>

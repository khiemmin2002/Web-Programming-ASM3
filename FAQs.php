...
<html lang="en-VN">
    <head>
        <title>FAQs | Infinis Mall | The biggest shopping center in Vietnam</title>
        <meta charset="UTF-8">
        ...
        <link rel="stylesheet" type="text/css" href="FAQs.css" media="screen">
    ...
    <body>
        ...
        <div id="container" class="site-container">
            ...
            <div class="box">
                ...
                <div class="faqs">
                    <details>
                        <summary><strong>Is everything at The Infinis Mall currently open?</strong></summary>
                        <p class="text">All of The Infinis Mall retail stores, attractions and dining options are open. Please check our directory page for an updated list.</p>
                    </details>  
                    <details>
                        <summary><strong>What are The Infinis Mall's hours?</strong></summary>
                        <p class="text">Current retail hours are Sunday-Thursday from 11:00 am to 7:00 pm and Friday + Saturday from 10:00 am to 9:00 pm.
                        You can also check the hours page. As a reminder, guests are required to wear a face covering during their visit. Children under 5 years old are exempt.
                        </p>
                    </details>
                    <details>
                        <summary><strong>When are the mall doors open for the public to enter?</strong></summary>
                        <p class="text"> The Infinis Mall's doors open three hours prior to when retail opens.</p>
                    </details>
                    <details>
                        <summary><strong>Are mall walkers allowed to walk The Infinis Mall before retail hours?</strong></summary>
                        <p class="text"> Yes. Mall walkers are welcome, but – like all guests – are required to wear a face mask that fully cover the mouth and nose.
                        Walkers must also practice social distancing. </p>
                    </details>
                    <details>
                        <summary><strong>Are food courts open?</strong></summary>
                        <p class="text">Yes, our food courts, fast casual, full-service and fine dining restaurants are open.
                        You can always visit our dining page for a complete list.</p>
                        </p>
                    </details>
                    <details>
                        <summary><strong>Are you giving out free face masks?</strong></summary>
                        <p class="text">Guests are required to bring and wear personal face masks with them when visiting The Infinis Mall. 
                        </p>
                    </details>
                    <details>
                        <summary><strong>Can I still enter The Infinis Mall if I forgot my face mask?</strong></summary>
                        <p class="text">No, you will not be able to enter The Infinis Mall without a face mask</p>
                    </details>
                </div>
            </div>
            <footer>

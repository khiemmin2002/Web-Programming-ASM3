...
<head>
    <title>iPhone 12 Pro Max | Apple | Infinis Mall | The biggest shopping center in Vietnam</title>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" type="text/css" href="Details.css" media="screen">
        ...
        <div class="main">
            <div class="product-categories">
                <div class="product-title">
                    <h2><strong>iPhone 12 Pro Max</strong></h2>
                    <span>
            ...
            <div class="product-contain">
                <div class="phone-img">
                    <img src="images/ip-12-pro-max.jpg" alt="iPhone 12 Pro Max" title="iPhone 12 Pro Max">
                </div>
                <div class="price-and-buy">
                    <div class="price">
                        <button onclick="pickOption({id: 1,name:'Iphone 12 Pro Max 128GB', price: 29990000, thumbnail: '/images/ip-12-pro-max.jpg'})" class="storage">128GB<br><span>29.990.000 VND</span></button>
                        <button onclick="pickOption({id: 2,name:'Iphone 12 Pro Max 256GB', price: 31990000, thumbnail: '/images/ip-12-pro-max.jpg'})" class="storage">256GB<br><span>31.990.000 VND</span></button>
                        <button onclick="pickOption({id: 3,name:'Iphone 12 Pro Max 512GB', price: 35990000, thumbnail: '/images/ip-12-pro-max.jpg'})" class="storage">512GB<br><span>35.990.000 VND</span></button>
                    </div>
                    <div class="buy-options">
                        <a onclick="addToCart()"><button class="purchase" id="add">Add to Cart</button></a>
                        <a onclick="addToCart()"><button class="purchase" id="buy">Buy Now</button></a>
                    </div>
                    <div class="discount">
                        <p>* You can save up to 10% if you are a member of The Infinis Mall and King Power</p>
                    </div>
                </div>
            </div>
        </div>

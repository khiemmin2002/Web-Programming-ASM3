...
<html lang="en-VN">
	<head>
        <title>Contact Us | Infinis Mall | The biggest shopping center in Vietnam</title>
        <meta charset="utf-8">
            ...
            <div class="form">
                ...
                <form action="index.php" onsubmit="return validation()">
                    ...
                    <div class="user-details">
                        <div class="input-box">
                            <label for="detail">Purpose of Contact</label>
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" name="name" id="name" placeholder="Enter your full name" maxlength="50" required>
                        </div>
                        ...
                        <div class="input-box">
                            <label for="detail">Preferred Contact Method</label><br>
                            <label class="radio">Phone
                                <input type="radio" value="contact" name="radio">
                                <span class="radiomark"></span>
                            </label>
                            <label class="radio">Email
                                <input type="radio" value="contact" name="radio">
                                <span class="radiomark"></span>
                            </label>
                        </div>
                        ...
                        <div class="input-box">
                            <label for="detail">Contact Days</label><br>
                        </div>
                        ...
                        <div class="message">
                            <label for="detail">Your Message</label><br>
                            <textarea cols="40" rows="10" id="message" name="message" placeholder="Write your message"></textarea>
                        </div>

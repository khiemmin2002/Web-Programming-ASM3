...
if (isset($_POST['login'])) {
    ...
    if ($password == $retypepassword) { // If password and re-type password are the same
        ...
        $open = fopen($admin_file, "a"); // Open the file
        ...
        $error = "Enter again"; // Call the variable for error
    }
}
            ...
            <div class="login-section">
                <div class="login-form">
                    <form method="POST">
                        ...
                        <!--Form Row-->
                        <p id="error" style="padding: 2px 16px 0 16px;font-size: 10px; color:#f00">
                            <?php
                        ...
                        <p id="successful" style="padding: 2px 16px 0 16px;font-size: 10px;color: green">
                            <?php

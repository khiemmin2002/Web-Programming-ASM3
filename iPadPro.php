...
<head>
    <title>iPad Pro 11-inch 2020| Apple | Infinis Mall | The biggest shopping center in Vietnam</title>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" type="text/css" href="iPadPro.css" media="screen">
        ...
        <div class="main">
            <div class="product-categories">
                <div class="product-title">
                    <h2><strong>iPad Pro 11-inch 2020</strong></h2>
                    <span>
            ...
            <div class="product-contain">
                <div class="phone-img">
                    <img src="images/iPad Pro 2020.jpg" alt="iPhone 12 Pro Max" title="iPhone 12 Pro Max">
                </div>
                <div class="price-and-buy">
                    <div class="price">
                        <button
                            onclick="pickOption({id: 4,name:'Ipad Pro 128GB', price: 19990000, thumbnail: '/images/iPad Pro 2020.jpg'})"
                            class="storage">128GB<br><span>19.990.000 VND</span></button>
                        <button
                            onclick="pickOption({id: 5,name:'Ipad Pro 256GB', price: 23990000, thumbnail: '/images/iPad Pro 2020.jpg'})"
                            class="storage">256GB<br><span>23.990.000 VND</span></button>
                        <button
                            onclick="pickOption({id: 6,name:'Ipad Pro 512GB', price: 26990000, thumbnail: '/images/iPad Pro 2020.jpg'})"
                            class="storage">512GB<br><span>26.990.000 VND</span></button>
                    </div>

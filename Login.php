<?php
$error = "";
$file = fopen("data/data_user.csv", "r");
...
if (isset($_POST['login'])) {
    ...
    while(list($id,$checkEmail,$phone,$checkPassword)=fgetcsv($file,1024,',')){
    ...
    <body>
        ...
        <div id="container" class="site-container">
            ...
            <div class="login">
                ...
                <h1>Login</h1>
                <form method="post" action="" onsubmit="return passwordChecking()">
                    ...
                    <button class="login_button" type="submit" value="Login" name="login">Login</button><br>
                    <div class="forgot">

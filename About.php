...
<html lang="en-VN">
    <head>
        <title>About The Mall | Infinis Mall | The biggest shopping center in Vietnam</title>
        <meta charset="UTF-8">
        ...
        <div id="container" class="site-container">
                ...
                <nav class="main-menu">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="About.php" class="active">The Mall</a>
            ...
            <div class="main">
                <div class="intro">
                    ...
                    <div class="title">
                        <h1>WELCOME TO THE INFINIS MALL</h1>
                    </div>
                </div><!--Intro-->
                <div class="description">
                    <div class="top-descrip">
                        <h4>About</h4>
                        <p id="top">The Infinis Mall is invested in the construction with the collaboration of King Power – the largest duty-free retailer in Thailand. With hundred of stores, the mall is expected to bring the best shopping experience to the customers in Thu Duc City as well as Ho Chi Minh City.</p>
                    </div>
                    <div class="second-descrip">
                        <h4>The scale</h4>
                        <p>Located in the Him Lam City Project with an area of more than 80000 square meters, the mall includes many popular brands around the world such as Balenciaga, Louis Vuitton,… Furthermore, there are several stores which first time come to Vietnam like Apple, Microsoft, NBA Store,… In the future, an entertainment complex will be opened in purpose to create a busy venue in the area of the East of the city.</p>
                    </div>
                </div>
            </div>
            <footer>
